    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_get_token.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    ProgressDialog progress = new ProgressDialog(MainViewer.this);
                    AsyncGetToken task_gettoken =  new AsyncGetToken(progress,MainViewer.this);
        ...
        btn_create_bucket.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    ProgressDialog progress = new ProgressDialog(MainViewer.this);
                    AsyncCreateBucket task_createtoken =  new AsyncCreateBucket(progress,MainViewer.this);
        ...
        btn_upload_model.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ProgressDialog progress = new ProgressDialog(MainViewer.this);
                AsyncUpload task_upload =  new AsyncUpload(progress,MainViewer.this);
                task_upload.execute();
        ...
        btn_post_job.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ProgressDialog progress = new ProgressDialog(MainViewer.this);
                AsyncPostJob task_post_job =  new AsyncPostJob(progress,MainViewer.this);
        ...
        btn_show_thumbnail.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                ProgressDialog progress = new ProgressDialog(MainViewer.this);
                AsyncThumbnail task_thumbnail =  new AsyncThumbnail(progress,MainViewer.this);
